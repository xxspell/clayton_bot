...
class GameAutomation:
    def __init__(self, http_client, init_data):
        ...
        self.setup_logger()  # Устанавливаем наш логгер
        ...
        try:
            ...
            if "user" in data:
                ...
                if start_time_str:
                    ...
                    self.start_time += timedelta(hours=6)  # Добавляем 6 часов к времени старта
    ...
    def start_game(self):
        ...
        if response:
            self.logger.info("Game start successfully.")
        else:
            self.logger.error("Failed to start game.")
        self.logger.debug(response)
    ...
    def end_game(self):
        ...
        if response:
            ...
            self.logger.error("Failed to end game.")
        self.logger.debug(response)
